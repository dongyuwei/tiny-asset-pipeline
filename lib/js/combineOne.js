...
var combine = function(filePath, beCombined, baseJsDir, config, tree) {
    ...
    if (fs.existsSync(filePath)) {
        ...
        if(filePath.match(/\.jsx(\.js)?$/)){//if file ends with `.jsx` or `.jsx.js`
            str = reactTools.transform(str, {
                harmony:    true,//enable ES6 features
                es6module:  false,//if true, will parses the file as an ES6 module
                target:     'es3' //ECMAScript 3, support >= IE8 browser
            });
        }
        try {
