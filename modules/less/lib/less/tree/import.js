...
tree.Import = function (path, imports, features, once, index, rootpath) {
    ...
    this.css = false;//process  *.css, too. modified by dongyuwei.

    // Only pre-compile .less files
    if (! this.css) {
        imports.push(this.path, function (e, root, imported) {
            if (e) { e.index = index }
            // if (imported && that.once) that.skip = imported; //ignore dulplicate @import, not just @import-once. 
            if (imported) that.skip = imported;
